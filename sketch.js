...
function setup() {
 ...
 mute_btn.mouseClicked(mute)
  ...
  rope = new Rope(7,{x:245,y:120});
  rope2 = new Rope(8,{x:370,y:200});
  rope3 = new Rope(7,{x:60,y:290});


  ground = new Ground(200,canh,canw+300,20);
  shelf = new Ground(500,200,150,20);

  blink.frameDelay = 20;
  eat.frameDelay = 20;

  bunny = createSprite(500,120,100,100);
  bunny.scale = 0.2;

bubble1 = createSprite(500,300,10,10)
